...
function do_custom_title_and_search_mobile($build_nav){
	?>
		...
		<header class= 'wi_homepage_header_mobile' id='wi_header' >
			<section class='wi_homepage_header_toprow_mobile'>

					<?php the_custom_logo(); ?>
					<?php  echo $build_nav; ?>
			</section>
			<section class="wi_mobile_header_image" id='mobile_hero_image' style='background-image: url(" <?php echo get_theme_mod("wi_hero_background_image"); ?> ")' ></section>
	    <section class='wi-homepage-cta'>
	        <h1><?php echo get_theme_mod("wi_hero_title"); ?></h1>
					<section>
						<p><?php echo get_theme_mod("wi_hero_text"); ?></p>
